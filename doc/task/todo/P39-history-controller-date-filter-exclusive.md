...
## Acceptance criteria
- [ ] Test với `startTime` đúng bằng mốc bắt đầu của tab (00:00:00 hôm nay/7 ngày trước/30 ngày trước) xuất hiện đúng trong tab tương ứng.
- [ ] Unit test cover boundary cho cả 3 case.
