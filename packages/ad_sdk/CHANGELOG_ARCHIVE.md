# Changelog archive (older releases)

Older entries moved out of `CHANGELOG.md` on 2026-09-17 (versions 1.1.0 and
earlier), again on 2026-09-20 (versions 1.2.4 through 1.1.1), and again on
2026-09-24 (versions 2.9.0 through 1.2.5) because pub.dev rejects a
CHANGELOG.md over 256 KB. Full history for versions 2.9.0 and earlier lives
here instead.
