...
> The real automated tests (all passing — see `CHANGELOG.md`'s top entry for
> the current file/test counts and SDK version) live in
> **`packages/ad_sdk/test/`** — run them with
