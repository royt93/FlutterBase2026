...
|---|---|---|
| 2.4.1–2.9.14 | Current stable (2026-09-02) | Not itemized here — this table stopped being kept in lockstep with releases after 2.4.0. See `CHANGELOG.md` for the real per-version history (round-24 through round-32 audits: consent-apply/TCF-timeout BLOCKER fixes, `AdBootstrapOptions.initTimeout`, AppLovin banner/MREC/native revenue-event wiring, and more). |
